...
def main():
    ...
    while True:
        ...
        if heroe.muerto == False and mundo < 11:
            ...
            pause, tiempo_p = heroe.buscar_colision_inv(invasores, tablero, mundo, pause, tiempo_p, tiempo_juego, poder,
                                                        bomb)
        ...
        pygame.display.flip()
        mundo = proximo_nivel(mundo, invasores, fondo2, ventana, tablero, heroe, clock, estrellas, estrellas2, aster,
                              etapa, tiempo_juego)
